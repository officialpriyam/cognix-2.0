...
export const ErrorMessage = ({
  ...
  const errorMessage =
    error.message === "An error occurred."
      ? "The chat request failed. If Auto is selected, no working configured model responded. Add a working provider key or start Ollama with an installed local model."
      : error.message;
  return (
